<?php include 'includes/header.php' ?>
  ...
  <section class="top-div">
    ...
    <div class="content">
      <h6>WHAT WE DO</h6>
      <h1>Our <span>Car fleet</span></h1>
    </div>
  </section>
  <section class="div-container fade-in-on-scroll">
    <div class="row">
        
        <div class="col-lg-6 col-md-6 col-sm-12 d-align-even">
        <div class="car-card">
        <img src="bootstrap/images/Luxury Car-1.jpg" alt="Car 1">
        <div class="car-info d-block">
          <h5>Range Rover</h5>
          <div class="d-align">
            <div class="features">
...
<div class="rental-form-box">
  ...
  <section class="div-container text-center pb-0 fade-in-left">
  ...
  <div class="container-form text-center img-new fade-in-right">
